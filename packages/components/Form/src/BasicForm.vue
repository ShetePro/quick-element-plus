  ...
  <div class="basic-form w-full">
    ...
    >
      <el-row class="flex flex-row flex-wrap" :gutter="20">
        <template v-for="col in getFormRenderColumn" :key="getFormItemKey(col)">
          <el-col :span="col.span" :style="getFormItemStyle(col)">
          ...
          <div class="w-full" v-if="col.row"></div>
        </template>
...
import FormGroup from '@/components/Form/src/FormGroup.vue'
